...
$("#multiplefileupload").fileinput(
    {
        ...
        dropZoneTitle: '<div class="upload-area"><i class="far fa-images"></i><p>Chọn hoặc thả file có đuôi .jpeg,.jpg, .png, .gif</p> <div> <button type="button">Chọn File</button> </div></div>',
        dropZoneClickTitle: "",
